        ...
        <View style={[s.body, { paddingTop: 20 }]}>
          <View style={s.twoCol}>
            ...
            <View style={[s.col, { marginRight: 16 }]}>
              ...
              {order.customer.address && <Text style={{ fontSize: 9, color: '#555', marginBottom: 2 }}>{order.customer.address}</Text>}
              {order.customer.email && <Text style={{ fontSize: 9, color: '#555', marginBottom: 2 }}>{order.customer.email}</Text>}
              {order.customer.phone && <Text style={{ fontSize: 9, color: '#555' }}>{order.customer.phone}</Text>}
            </View>
            ...
            <View style={s.col}>
              ...
              {order.paymentMethod && (
                <>
                  ...
                  <Text style={s.fieldValue}>{order.paymentMethod}</Text>
                </>
              )}
            </View>
          </View>
